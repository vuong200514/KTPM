...
BeatStage() {
    ...
    if (CurrentChallenge = ShibuyaAftermathBounty) {
        ...
        ; Place farm and unit
        PlaceUnitCheck2(410, 104, 2)
        PlaceUnitCheck2(450, 104, 2)
        PlaceUnitCheck2(490, 104, 2)

        PlaceUnitCheck2(490, 211, 1)
        PlaceUnitCheck2(530, 211, 1)
        PlaceUnitCheck2(570, 211, 1)
        ; Upgrade farm
        UpgradeFarm2(410, 104)
        UpgradeFarm2(450, 104)
        UpgradeFarm2(490, 104)
        ; Place Damage unit
        PlaceUnitCheck2(385, 247, 5)
        PlaceUnitCheck2(338, 302, 6)
        Sleep 100
        UpgradeDpsSkill(385, 247, 7)
        UpgradeDps2(338, 302, 10)
        loop {
            if (ok := FindText(&X, &Y, 342 - 150000, 135 - 150000, 342 + 150000, 135 + 150000, 0, 0, EndScreen)) {
                AddToLog("Found return to lobby button")
                EndscreenFuncs()
    ...
    ;ok
        ...
        PlaceUnitCheck2(295, 420, 2)
        PlaceUnitCheck2(335, 420, 2)
        PlaceUnitCheck2(375, 420, 2)
        PlaceUnitCheck2(322, 95, 5)
        PlaceUnitCheck2(592, 311, 6)
        PlaceUnitCheck2(662, 159, 1)
        ChangePriority(662, 159, 5) ; Change priority to boss
        UpgradeFarm2(295, 420)
        UpgradeFarm2(335, 420)
        UpgradeFarm2(375, 420)
        UpgradeDps2(322, 95, 10)
        UpgradeDps2(662, 159, 7)
        UpgradeDps2(592, 311, 8)
        loop {
            if (ok := FindText(&X, &Y, 342 - 150000, 135 - 150000, 342 + 150000, 135 + 150000, 0, 0, EndScreen)) {
                AddToLog("Found return to lobby button")
                EndscreenFuncs()
